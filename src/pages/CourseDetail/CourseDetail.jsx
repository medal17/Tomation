        ...
        (
            <>
                    ...
                    courseDetail.isPaidforCourse ==true?
                                ...
                                (
                                    <>           
                                        ...
                                        <button className="btn btn-white p-4 py-3">Book a Call Now</button>
                                    </>
                                )
                            }
                    ...
                    <div className="container danload_brochureContainer" >
                        ...
                        <a href={courseDetail.courseDetail[0].brochure} className="btn btn-primary p-3 py-3">Danload Brochure</a>
                    </div>
