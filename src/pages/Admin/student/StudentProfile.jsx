...
const creatNewEducationalQulificaationField = (e)=>{
   ...
   setEducationQualification([...educationQualification,{uiID:Math.random()*150,"degree_type":"",
...
const creatNewProfessionalQulificaationField = (e)=>{
   ...
   setProfessionalQualification([...professionalQualification,{uiID:Math.random()*150,"degree_type":"",
...
(
                                 ...
                                 <i class="fas fa-plus-circle" style={{color:"greenyellow",cursor:"pointer"}}
                                 onClick={(e)=>{
...
style={{color:"red",position:"absolute",right:"0","cursor":"pointer"}}></i>
            ...
            type="text" value={data.course_name} className="form-control" />
                                                   ...
                                                   style={{color:"greenyellow",cursor:"pointer"}}></i>
                                                </fieldset> 
...
<i 
                                             ...
                                             class="fas fa-plus-circle" style={{color:"greenyellow",cursor:"pointer"}}
